...
- Similarity settings now provide custom creation controls for size floors, media scope, thumbnail frames, resize dimensions, quantization, grayscale, duration units, and similarity group member browsing.
