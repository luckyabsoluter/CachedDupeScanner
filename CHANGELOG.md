...
- Similarity cluster detail video members now provide an optional timeline video preview using the configured video preview cache, width snap, line count, and frame size.
