...
- Simple home, permission, settings, scan, and DB screens no longer render standalone side scrollbars; result-style lazy scrollbars remain on long result/list screens.
