...
- Filter editor clusters now provide saveable collapsible headers that retain cluster identity, rule count, logic, enablement, removal, any open rule editor state, and collapsed clusters when the filter screen is reopened.
