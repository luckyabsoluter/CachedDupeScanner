...
- Simple home, permission, settings, scan, and DB screens now use the shared result-style lazy side scrollbar instead of the standalone scroll-state scrollbar.
