...
- Similarity cluster detail video members now show timeline video previews using the configured video preview cache, width snap, line count, and frame size.
