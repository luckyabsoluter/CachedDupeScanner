...
- **Smart filters**: Saved filters, filter editing, same-folder and same-size group rules, similarity average-duration tolerance, and modified-time rules that persist across sessions.
