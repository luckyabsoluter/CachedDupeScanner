...
- **Similarity settings**: configure video/image similarity clustering that is generated from scan-cache data after scans, with sidecar links for active cached files.
