...
- **Advanced bulk delete**: Full-candidate previews support keeping the oldest, newest, shortest-duration, or longest-duration file, with modified-time fallback for equal video durations.
