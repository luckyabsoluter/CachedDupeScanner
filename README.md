...
- **Similarity settings**: configure video/image similarity clustering generated from scan-cache data after scans, with per-setting Update/Rebuild actions for scan-cache catch-up or full recalculation.
